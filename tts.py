...
NATIVE_VOICES: dict[str, list[tuple[str, str]]] = {
    ...
    "por_pt": [
        ...
        ("Claudia", "JGnWZj684pcXmK2SxYIv"),
        ("Joana", "nJ5NFqyKb8kn9JBPmo6i"),
        ("Benedita", "NkpT2jezTenCDRKHkWiX"),
        ("Marta", "bBNhdwrIjl4fcVYiRbT2"),
        ("Daniela", "IZipF5JhqPlWzpduTV0E"),
    ],
    "spa": [
        ("El Faraon", "8mBRP99B2Ng2QwsJMFQl"),
        ("Martin Alvarez", "Wl3O9lmFSMgGFTTwuS6f"),
        ("Lily", "zl7szWVBXnpgrJmAalgz"),
        ("Adrian", "aZW91ASeaJuQl7yXe6Vk"),
        ("Virnyta", "yXuNq2Xj0YELmX80vsg0"),
        ("Gustavo", "u1ajuyOsyYeV4hsCaYXs"),
    ],
    "fra": [
        ("Adam", "93nuHbke4dTER9x2pDwE"),
        ("Guillaume", "ohItIVrXTBI80RrUECOD"),
        ("Paul K", "5l4ttmr4SKNgi0HnOelT"),
        ("Bass", "wQjKP9DkO6pDLKdaqFn6"),
        ("Keli", "hzuja6LJVafBxphAzQRB"),
        ("Fred", "sOtdnM6kZo7osJcZj9ew"),
    ],
    "ita": [
        ("Marco", "13Cuh3NuYvWOVQtLbRN8"),
        ("Tiziana", "RXoaSpLaWTEckJgPUBG3"),
        ("Andrea Loco", "paraDwhkbSkX4FhBkAzc"),
        ("Roberta", "BrADZHWW7Di4Z7YPNjmK"),
        ("Alessandro", "PvXX19xtdMoxUZ4Jhu9p"),
        ("Rossana", "MuTiG4dbrEGYEy3XP4iP"),
    ],
    "pol": [
        ("Kamil", "mr1ubFaLs5xVrh1EqWtc"),
        ("Jaca", "Czpm0ILwHmgdxzeIhCyL"),
        ("Tomasz", "ozf4fnQ34uFcOcKX71uX"),
        ("Jan Gajos", "pSeHjczf70JDXR8uNDkN"),
        ("Michał", "sNh3wakVwZdRw8WRiPsv"),
        ("Dominik", "rlOC0niXHLpAyBCMNR2V"),
    ],
    "ces": [
        ("Oliver", "daJ4gHLkIVFskWuoLuDX"),
        ("Zdeněk", "vP4R9CqQI4q0HlVrXJWj"),
        ("Hanka", "12CHcREbuPdJY02VY7zT"),
        ("MX", "CaFTofOBrFxHXjA09WqP"),
        ("Jana", "iEDNGgJB5s5IueXbbhCS"),
        ("Kuba", "pt8Kvp57SW3o4WuGqWZG"),
    ],
    "tur": [
        ("Adam", "RXCCWbOxP7Hisa63Xsv5"),
        ("Yunus", "fXhoW006nc5Wf8xkGVSy"),
        ("Cavit", "lxZLq5dcyw12UangGJgN"),
        ("Rozetmen", "f9MgSVQ9cYWMCf3sk9ut"),
        ("Gunes", "udLwzEbogxcOoUnlS3Dc"),
        ("Seckin Yigit", "nA7C14u2DhGhE4ZLOyGF"),
    ],
    "jpn": [
        ("Ritsuto", "A4AyGcPAjb1pHgflyZZp"),
        ("Kano", "OSwaPSNdfituxkWcjlkR"),
        ("Lime", "q3eHxuMah31iifOfMrz0"),
        ("Miki T", "51WoBv13cwDXZGNZ3TLb"),
        ("Taichi", "FRg1cTnJJs6wVaFolzWw"),
        ("Kinako", "t3iNwCjYhE9IEQPVBlys"),
    ],
    "kor": [
        ("Yohan Koo", "4JJwo477JUAx3HV0T7n7"),
        ("Rosa Oh", "sf8Bpb1IU97NI9BHSMRf"),
        ("Marcus", "ibCGc01503OQd2R6i1n1"),
        ("Inbeul", "GcdAArSHrZw06Pf1X4Df"),
        ("Claire", "ZRJMGKt2Okf3o9C38eSq"),
        ("Jaeil", "HYALOqtTLlRjxo4uBKeg"),
    ],
    "zho": [
        ("Evan Zhao", "MI36FIkp9wRP7cpWKPTl"),
        ("Mingyao Ye", "JZLpE3AGwpKYZI2X65hN"),
        ("Anna Su", "9lHjugDhwqoxA5MhX0az"),
        ("Patrick", "ERfvBpcWqb5NO6zGEzPW"),
        ("Pangge", "hFamrilbAE6WDMtWgKvu"),
    ],
}
